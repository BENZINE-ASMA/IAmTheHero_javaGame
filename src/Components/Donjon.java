...
/**
 * Classe représentant une case de donjon sur le plateau.
 */
public class Donjon extends CaseTraversable {
	...
	/**
	 * Constructeur pour initialiser un Donjon avec une entité spécifique.
	 *
	...
	/**
	 * Constructeur pour initialiser un Donjon vide.
	 *
	 * @param l ligne de la case sur le plateau
	 * @param c colonne de la case sur le plateau
	 */
