...
2. **Télécharger le JAR et exécuter le jeu en version console**
   ...
   ```
3. **Changer les adresses des médias utilisés** : Dans JeuConsole, PanelComponent et FrameComponent, changer la valeur de l'attribut baseFolder par le chemin absolu correspondant dans votre ordinateur : "C:\\xxxxxx\\IAmTheHero_javaGame\\src\\";
